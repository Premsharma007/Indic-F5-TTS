    ...
    // windows nvidia
    {
      ...
      "params": {
        ...
        "message": [
          ...
          "{{args && args.sageattention ? 'uv pip install https://github.com/deepbeepmeep/SageAttention/raw/refs/heads/main/releases/sageattention-2.1.0-cp310-cp310-win_amd64.whl' : ''}}"
        ]
      },
      "next": null
    },
